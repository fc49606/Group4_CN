...
kubectl create secret generic secret-db --from-literal=host=127.0.0.1:5432 --from-literal=username=postgres --from-literal=password=root --from-literal=database=movies --from-literal=datababasestreaming=movies_streaming_plataform
